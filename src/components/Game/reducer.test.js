...
const _ = undefined;
const o = 'O';
const emptyPlayField = [...Array(22)].map(() => [...Array(10)].map(() => undefined));
const initialState = {
...
describe('reducer', () => {
    ...
    describe('move', () => {
        ...
        it('sets phase to locking when a tetromino is landed', () => {
            const result = reducer({...initialState, tetromino: {...O, top: 19 } }, { type: 'move', payload: directions.down });
        ...
        it('locks a landed tetromino if phase is locking', () => {
            ...
            const result = reducer({...initialState, tetromino, phase: phases.locking }, { type: 'move', payload: directions.down });
        ...
        it('still allows move when locking', () => {
            const tetromino = {...O, top: 20 };
            const result = reducer({...initialState, tetromino, phase: phases.locking }, { type: 'move', payload: directions.right });
            expect(result.phase).to.equal(phases.locking);
        ...
        it('does not set locking to true before a tetromino is landed', () => {
            const result = reducer({...initialState, tetromino: {...O, top: 18 } }, { type: 'move', payload: directions.down });
    ...
    describe('tick', () => {
        ...
        it('sets phase to locking when a tetromino is landed', () => {
            const result = reducer({...initialState, tetromino: {...O, top: 19 } }, { type: 'tick' });
            expect(result.tetromino).to.deep.equal({...O, top: 20 });
            expect(result.phase).to.equal(phases.locking);
        });
    });
    describe('lock', () => {
        it('locks the tetromino, sets phase to clearing', () => {
            const tetromino = {...O, top: 20 };
            const result = reducer({...initialState, tetromino, phase: phases.locking }, { type: 'lock' });
    ...
    describe('clear', () => {
        const playfield = [
            ...[...Array(21)].map(() => [_, _, _, _, _, _, _, _, _, _]), [o, o, o, o, o, o, o, o, o, o]
        ];
    ...
    describe('spawn', () => {
        it('spawns a tetrimino from the queue', () => {
            const result = reducer({...initialState, tetromino: undefined, phase: phases.spawning }, {
                type: 'spawn'
            });
            expect(result.phase).to.equal(phases.descending);
    ...
    describe('start', () => {
        it('initialises state', () => {
            const result = reducer({ phase: phases.pending }, {
                type: 'start',
    ...
    describe('hold', () => {
        ...
        it('spawns a held tetromino', ()=>{
          const result = reducer({...initialState, hold: T}, {
            type: 'hold'
          });
